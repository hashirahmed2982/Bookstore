...
class ProductBookmarks extends StatefulWidget {
  const ProductBookmarks({Key? key,
  ...
  @override
  _ProductBookmarksState createState() => _ProductBookmarksState();
}

class _ProductBookmarksState extends State<ProductBookmarks> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: (){
              Navigator.pop(context);
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => MyBookmarks(analytics: widget.analytics, observer: widget.observer,)));
            },
          ),
