...
class ProductOfferedProducts extends StatefulWidget {
  const ProductOfferedProducts({Key? key,
  ...
  @override
  _ProductOfferedProductsState createState() => _ProductOfferedProductsState();
}

class _ProductOfferedProductsState extends State<ProductOfferedProducts> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: (){
              Navigator.pop(context);
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => MyOfferedProducts(analytics: widget.analytics, observer: widget.observer,)));
            },
          ),
