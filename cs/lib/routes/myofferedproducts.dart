...
import 'package:cs/routes/productofferedproducts.dart';
...
class MyOfferedProducts extends StatefulWidget {
  const MyOfferedProducts({Key? key, required this.analytics, required this.observer}) : super(key: key);

  final FirebaseAnalytics analytics;
  final FirebaseAnalyticsObserver observer;

  @override
  _MyOfferedProductsState createState() => _MyOfferedProductsState();
}

class _MyOfferedProductsState extends State<MyOfferedProducts> {
            ...
            Expanded(
                child: GridView.builder(
                    ...
                    itemBuilder: (context, index) => GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) =>  ProductOfferedProducts(
