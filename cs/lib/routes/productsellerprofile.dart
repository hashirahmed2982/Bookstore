...
class ProductSellerProfile extends StatefulWidget {
  const ProductSellerProfile({Key? key,
  ...
  @override
  _ProductSellerProfileState createState() => _ProductSellerProfileState();
}

class _ProductSellerProfileState extends State<ProductSellerProfile> {
